...
const ChatBot = () => {
    ...
    return (
        <div className="container mt-5">
            <div className="card shadow-lg" style={{ height: "444px", overflowY: "auto" }}>
                ...
                <div className="card-body chat-box" style={{ height: "400px", overflowY: "auto" }}>
                    {messages.map((msg, index) => (
                        <div key={index} className={`d-flex ${msg.sender === "user" ? "justify-content-end" : ""}`}>
                            <div className={`p-3 rounded shadow ${msg.sender === "user" ? "bg-primary text-white" : "bg-light text-dark"}`}>
                                {msg.text}
                            </div>
                        </div>
                    ))}
